 ...
 */
class TldPriceWithPromoInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('promotion_details', $data ?? [], null);
    ...
    */
    ...
    public function setPromotionDetails($promotion_details)
    {
        if (is_null($promotion_details)) {
            throw new \InvalidArgumentException('non-nullable promotion_details cannot be null');
        }
