 ...
 */
class OrderSslOrderDomainValidationStatuses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('ca_operation', $data ?? [], null);
        $this->setIfExists('ca_order_status', $data ?? [], null);
        $this->setIfExists('ca_status', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($ca_operation)) {
            throw new \InvalidArgumentException('non-nullable ca_operation cannot be null');
        }
    ...
    {
        if (is_null($ca_order_status)) {
            throw new \InvalidArgumentException('non-nullable ca_order_status cannot be null');
        }
    ...
    {
        if (is_null($ca_status)) {
            throw new \InvalidArgumentException('non-nullable ca_status cannot be null');
        }
