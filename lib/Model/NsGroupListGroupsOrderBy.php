 ...
 */
class NsGroupListGroupsOrderBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ns_count', $data ?? [], null);
        $this->setIfExists('ns_group', $data ?? [], 'asc');
    }
    ...
    */
    ...
    {
        if (is_null($ns_count)) {
            throw new \InvalidArgumentException('non-nullable ns_count cannot be null');
        }
