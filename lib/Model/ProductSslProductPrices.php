 ...
 */
class ProductSslProductPrices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'extra_domain_price' => false,
        'extra_wildcard_domain_price' => false,
        'period' => false,
        'price' => false
    ];
    ...
    {
        $this->setIfExists('extra_domain_price', $data ?? [], null);
        $this->setIfExists('extra_wildcard_domain_price', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($extra_domain_price)) {
            throw new \InvalidArgumentException('non-nullable extra_domain_price cannot be null');
        }
    ...
    {
        if (is_null($extra_wildcard_domain_price)) {
            throw new \InvalidArgumentException('non-nullable extra_wildcard_domain_price cannot be null');
        }
