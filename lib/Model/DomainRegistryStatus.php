 ...
 */
class DomainRegistryStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('is_changeable', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($is_changeable)) {
            throw new \InvalidArgumentException('non-nullable is_changeable cannot be null');
        }
