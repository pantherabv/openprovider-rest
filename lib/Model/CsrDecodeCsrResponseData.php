 ...
 */
class CsrDecodeCsrResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('domain_names_count', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($domain_names_count)) {
            throw new \InvalidArgumentException('non-nullable domain_names_count cannot be null');
        }
