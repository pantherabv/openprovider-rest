 ...
 */
class SeDomainRecords implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('outgoing_user_ips', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($outgoing_user_ips)) {
            throw new \InvalidArgumentException('non-nullable outgoing_user_ips cannot be null');
        }
