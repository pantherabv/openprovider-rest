 ...
 */
class DomainTokenCreateTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zone_provider', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($zone_provider)) {
            throw new \InvalidArgumentException('non-nullable zone_provider cannot be null');
        }
