 ...
 */
class SettingsPaymentMethodSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'transaction_fee_absolute' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transaction_fee_absolute', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($transaction_fee_absolute)) {
            throw new \InvalidArgumentException('non-nullable transaction_fee_absolute cannot be null');
        }
