 ...
 */
class ContactPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('subscriber_number', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($subscriber_number)) {
            throw new \InvalidArgumentException('non-nullable subscriber_number cannot be null');
        }
