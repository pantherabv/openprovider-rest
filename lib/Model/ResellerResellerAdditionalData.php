 ...
 */
class ResellerResellerAdditionalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('cif_nif_number', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($cif_nif_number)) {
            throw new \InvalidArgumentException('non-nullable cif_nif_number cannot be null');
        }
