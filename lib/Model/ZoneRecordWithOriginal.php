 ...
 */
class ZoneRecordWithOriginal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('original_record', $data ?? [], null);
    ...
    */
    ...
    public function setOriginalRecord($original_record)
    {
        if (is_null($original_record)) {
            throw new \InvalidArgumentException('non-nullable original_record cannot be null');
        }
