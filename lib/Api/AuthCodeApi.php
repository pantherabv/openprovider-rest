...
class AuthCodeApi
{
    ...
    {
        list($response) = $this->getAuthCodeWithHttpInfo($id, $domain_name, $domain_extension, $auth_code_type, $sending_type, $contentType);
        return $response;
    }
     ...
     */
    public function getAuthCodeAsync($id, $domain_name = null, $domain_extension = null, $auth_code_type = null, $sending_type = null, string $contentType = self::contentTypes['getAuthCode'][0])
    {
        return $this->getAuthCodeAsyncWithHttpInfo($id, $domain_name, $domain_extension, $auth_code_type, $sending_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getAuthCodeRequest($id, $domain_name = null, $domain_extension = null, $auth_code_type = null, $sending_type = null, string $contentType = self::contentTypes['getAuthCode'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $auth_code_type,
            'auth_code_type', // param base name
            'string', // openApiType
            '', // style
            false, // explode
            false // required
    ...
    {
        list($response) = $this->resetAuthCodeWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetAuthCodeAsync($id, $body, string $contentType = self::contentTypes['resetAuthCode'][0])
    {
        return $this->resetAuthCodeAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetAuthCodeRequest($id, $body, string $contentType = self::contentTypes['resetAuthCode'][0])
    {
