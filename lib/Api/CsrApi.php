...
class CsrApi
{
     ...
     */
    public function createCsrAsync($body, string $contentType = self::contentTypes['createCsr'][0])
    {
     ...
     */
    public function createCsrRequest($body, string $contentType = self::contentTypes['createCsr'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function decodeCsrAsync($body, string $contentType = self::contentTypes['decodeCsr'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function decodeCsrRequest($body, string $contentType = self::contentTypes['decodeCsr'][0])
    {
