...
class TransactionApi
{
    ...
    {
        list($response) = $this->listTransactionsWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date, $filter_for_subject, $contentType);
        return $response;
    }
     ...
     */
    public function listTransactionsAsync($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        return $this->listTransactionsAsyncWithHttpInfo($limit, $offset, $order, $order_by, $start_creation_date, $end_creation_date, $filter_for_subject, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function listTransactionsRequest($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $filter_for_subject,
            'filter_for_subject', // param base name
            'string', // openApiType
            '', // style
            false, // explode
            false // required
