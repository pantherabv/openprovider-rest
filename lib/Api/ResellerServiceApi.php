...
class ResellerServiceApi
{
     ...
     */
    public function getResellerAsync($with_additional_data = null, $with_statistics = null, $with_settings = null, $with_contacts = null, string $contentType = self::contentTypes['getReseller'][0])
    {
     ...
     */
    public function getResellerRequest($with_additional_data = null, $with_statistics = null, $with_settings = null, $with_contacts = null, string $contentType = self::contentTypes['getReseller'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateResellerAsync($id, $body, string $contentType = self::contentTypes['updateReseller'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateResellerRequest($id, $body, string $contentType = self::contentTypes['updateReseller'][0])
    {
